...
import { reducer_AddressIndex } from '../../modules/addr_index_getData';
...
const IndexProgress = (props) => {
  ...
  return (
    <div className="system-progress">
      ...
      <p>
        The TrueBlocks index is a set of files that save appearances in the form blockNumber, transactionId, traceId,
        address. These files are roughly the same size. You can set some options about this in the Settings tab.
      </p>
      {container}
    </div>
  );
